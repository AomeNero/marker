...
A transparent always-on-top WebView over GPU-accelerated video (e.g. Bilibili in Chrome/Edge) conflicts with the browser’s hardware video overlay plane. The video region paints black while Marker is annotating.
