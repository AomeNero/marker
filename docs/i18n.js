(function () {
  ...
  const messages = {
    en: {
      'meta.title': 'Marker - Lightweight Screen Annotation Tool',
      'meta.description':
        'Marker is a lightweight open-source screen annotation tool with whiteboard mode and keyboard-first drawing for Windows and macOS.',
      'meta.keywords':
        'screen annotation tool, desktop drawing overlay, desktop whiteboard, Tauri app, screen drawing',
      'meta.ogTitle': 'Marker - Lightweight Screen Annotation Tool',
      'meta.ogDescription':
        'Draw, highlight, and annotate anywhere on your desktop. Press V to hide annotations while you interact with apps below.',
      'helpPage.meta.title': 'Marker Help & Shortcuts',
      'helpPage.meta.description':
        'Marker keyboard shortcuts and help: global hotkeys, drawing tools, whiteboard, ink visibility, and modifier tips for Windows and macOS.',
      'helpPage.meta.keywords':
        'Marker help, screen annotation shortcuts, whiteboard shortcuts, Alt+G, keyboard drawing',
      'helpPage.meta.ogTitle': 'Marker Help & Shortcuts',
      'helpPage.meta.ogDescription':
        'Learn Marker shortcuts: enter annotation, switch tools, hide or show ink, whiteboard, colors, and drag tips.',
      'skip': 'Skip to content',
      'nav.aria': 'Primary navigation',
      'nav.brandAria': 'Marker home',
      ...
      'helpPage.lead':
        'Keyboard-first annotation for demos and teaching. Quick reference for global hotkeys, tools, modifiers, and ink visibility.',
      ...
      'helpPage.aside.sub': 'Top 3 essentials',
      ...
      'helpPage.quick.step1Body':
        'Marker runs in the system tray. Launching again while it is already running toggles annotation — same as clicking the tray icon.',
      ...
      'helpPage.quick.step3Body': `Press <kbd>V</kbd> to hide annotations while you click below; press again to restore. <kbd>Esc</kbd> exits. <kbd>Space</kbd> opens the toolbar.`,
      ...
      'helpPage.global.note':
        'While drawing, press <kbd>V</kbd> to hide or show annotations, or <kbd>Esc</kbd> to exit annotation.',
      ...
      'helpPage.tips.title': 'Ink visibility & drag tips',
      'helpPage.tips.lead': 'Keep marks on screen while you present — then hide or move them when needed.',
      'helpPage.tips.hideInkTitle': 'Hide / show annotations',
      'helpPage.tips.hideInkBody': `Press <kbd>V</kbd> to hide all annotations — clicks reach the app below — then press again to restore.`,
      ...
      'helpPage.tips.toolbarBody':
        'Press Space for the floating toolbar. It auto-hides while you draw; Space brings it back. Pin to stay visible.',
      ...
      'bottom.helpLinkDesc': 'Tools, modifiers, whiteboard, and ink tips.',
      ...
      'hero.chip.hideInk': 'Hide / show annotations',
      ...
      'features.hideInkTitle': 'Hide / show annotations',
      'features.hideInkBody': `Press <kbd>V</kbd> to temporarily hide all annotations while you interact with apps below, then press again to bring them right back.`,
      ...
      'bottom.title': 'Download Marker or read the FAQ.',
      ...
      'bottom.faq1Title': 'What is Marker for?',
      'bottom.faq1Desc':
        'Live screen annotation for demos, teaching, and meetings — keyboard-first tools built in.',
      'bottom.faq2Title': 'How do I interact with apps below my annotations?',
      'bottom.faq2Desc': `Press <kbd>V</kbd> to hide all annotations, use the app underneath, then press again to restore.`,
    ...
    'zh-CN': {
      'meta.title': 'Marker - 轻量级屏幕标注工具',
      'meta.description':
        'Marker 是一款轻量级开源屏幕标注工具，支持白板模式与快捷键优先绘制，适用于 Windows 和 macOS。',
      'meta.keywords':
        '屏幕标注工具, 桌面标注, 桌面白板, Tauri 应用, 屏幕绘画',
      'meta.ogTitle': 'Marker - 轻量级屏幕标注工具',
      'meta.ogDescription':
        '在桌面任意位置绘画、高亮与标注。按 V 即可隐藏标注、操作下层应用。',
      'helpPage.meta.title': 'Marker 帮助与快捷键',
      'helpPage.meta.description':
        'Marker 快捷键与使用帮助：全局热键、绘画工具、白板、标注显隐与修饰键提示，适用于 Windows 和 macOS。',
      'helpPage.meta.keywords':
        'Marker 帮助, 屏幕标注快捷键, 白板快捷键, Alt+G, 键盘绘画',
      'helpPage.meta.ogTitle': 'Marker 帮助与快捷键',
      'helpPage.meta.ogDescription':
        '查阅 Marker 快捷键：进入标注、切换工具、隐藏/显示标注、白板、颜色与拖拽技巧。',
      'skip': '跳到主要内容',
      'nav.aria': '主导航',
      'nav.brandAria': 'Marker 首页',
      'nav.linksAria': '产品链接',
      'nav.features': '功能',
      'nav.help': '帮助',
      'nav.download': '下载',
      ...
      'helpPage.lead':
        '面向演示与教学的快捷键优先标注。本页速查全局热键、工具、修饰键与标注显隐。',
      ...
      'helpPage.quick.step1Body':
        'Marker 在系统托盘运行。应用已在后台时再次启动会切换标注 — 与点击托盘图标相同。',
      ...
      'helpPage.quick.step3Body': `按 <kbd>V</kbd> 隐藏标注、点击下层应用，再按恢复。<kbd>Esc</kbd> 退出。<kbd>Space</kbd> 呼出工具栏。`,
      'helpPage.global.eyebrow': '02',
      ...
      'helpPage.global.clearMac': clearComboMac,
      'helpPage.global.note':
        '绘制中可按 <kbd>V</kbd> 隐藏/显示标注，或按 <kbd>Esc</kbd> 退出标注。',
      'helpPage.tools.eyebrow': '03',
      ...
      'helpPage.tips.eyebrow': '05',
      'helpPage.tips.title': '标注显隐与拖拽技巧',
      'helpPage.tips.lead': '演示时让标注留在屏幕上 — 需要时再隐藏、移动或编辑。',
      'helpPage.tips.hideInkTitle': '隐藏 / 显示标注',
      'helpPage.tips.hideInkBody': `按 <kbd>V</kbd> 隐藏全部标注，点击直达下层应用，再按恢复。`,
      ...
      'hero.quickStep2Keys': '<kbd>V</kbd>',
      'hero.quickStep2Desc': '隐藏 / 显示标注',
      'hero.quickStep3Keys': '<kbd>Esc</kbd>',
      'hero.quickStep3Desc': '退出',
      'hero.quickStep4Keys': '<kbd>Space</kbd>',
      'hero.quickStep4Desc': '呼出工具栏',
      'proof.aria': '为什么选择 Marker',
      ...
      'features.hideInkTitle': '隐藏 / 显示标注',
      'features.hideInkBody': `按 <kbd>V</kbd> 临时隐藏全部标注、操作下层应用，再按即可恢复。`,
      ...
      'shortcuts.board': '白板',
      'bottom.eyebrow': '开始使用',
      'bottom.title': '下载 Marker 或查看常见问题。',
      ...
      'bottom.faq1Title': 'Marker 适合什么场景？',
      'bottom.faq1Desc': '演示、教学、会议与录屏时的屏幕标注，内置快捷键工具。',
      'bottom.faq2Title': '怎么操作被标注覆盖的下层应用？',
      'bottom.faq2Desc': `按 <kbd>V</kbd> 隐藏全部标注，操作下层应用后再按恢复。`,
