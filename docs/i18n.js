(function () {
  ...
  const messages = {
    en: {
      ...
      'meta.description':
        'Marker is a lightweight open-source screen annotation tool with click-through mode, whiteboard mode, and keyboard-first drawing for Windows and macOS.',
      'meta.keywords':
    ...
    'zh-CN': {
      ...
      'meta.description':
        'Marker 是一款轻量级开源屏幕标注工具，支持穿透模式、白板模式与快捷键优先绘制，适用于 Windows 和 macOS。',
      'meta.keywords':
