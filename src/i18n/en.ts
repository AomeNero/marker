export default {
  ...
  toolDesc: {
    ...
    arrow: 'Arrow pointer line; press 4 again to switch crosshair / dot cursor',
    rect: 'Rectangle outline; press 5 again to switch crosshair / dot cursor',
    ellipse: 'Ellipse outline; press 6 again to switch crosshair / dot cursor',
    line: 'Straight line segment; press 7 again to switch crosshair / dot cursor',
    eraser: 'Stroke or object erase; press E again to switch',
  ...
  settings: {
    ...
    autoStartFailedEnable:
      'Could not enable launch at startup. Allow Marker in your system login/startup items (and any security software that may have blocked it), then try again.',
  ...
  help: {
    ...
    eraserModeHint: 'With eraser selected, press E to switch stroke / object erase',
    penCursorHint: 'With pen selected, press 1 to switch pen icon / dot cursor',
    crosshairCursorHint: 'With a shape selected, press its key again to switch crosshair / dot',
    editAndOther: 'Edit',
