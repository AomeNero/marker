...
**Marker** is a lightweight desktop screen annotation tool. We highly value your privacy, and this policy explains how we handle your data.

## Data Collection and Usage

### Information We Do **Not** Collect

Marker explicitly commits to:
...
Marker only saves the following information locally:
...
Marker does **not** send telemetry, crash reports, or user content to remote servers.
...
Marker is **local-first**: no account, no cloud sync of drawings. It is **not** a zero-network app when you use updates or open external links.

## Data Protection and Deletion

Configuration stays on your machine. Marker does not remotely sync or upload it.
...
System permissions requested by Marker are only used to implement core functions:
...
If there are significant changes, we will post notifications on the [project homepage](https://marker.cn/) and GitHub.
